...
function Order() {
	...
	return (
		<div className="container mx-auto py-6 px-4 min-[70vh]">
			<div className="text-3xl font-bold mb-6 text-center">Your Order's</div>
						...
						>
							...
							<CardContent>
								<p>
									...
									<span
										className={`${order.status === "pending" ? "text-yellow-400" : "text-green-500"}`}
									>
										{order.status}
									</span>
								</p>
